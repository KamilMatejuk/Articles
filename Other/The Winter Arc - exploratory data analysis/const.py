COLS_SLEEPING = ['sleep_night_time', 'sleep_day_time', 'sleep_total_time']
COLS_READING = ['read_book_time', 'read_crossword_time', 'read_total_time']
COLS_WORKING = ['side_projects_time']
COLS_LEISURE = ['phone_time', 'tv_time']
COLS_EXERCISE = ['exercise_volleyball_time', 'exercise_gym_time', 'exercise_home_time', \
